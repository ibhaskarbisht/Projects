...
class printForMe implements ActionListener{
    JFrame f;
    ...
    String emp_id,name,father,address,phone,email,salary,post,age,dob,doj;
    JButton b1,b2;
    ImageIcon icon;

    printForMe(String e_id){
        try{
            conn con = new conn();
        ...
        id8 = new JLabel("ONGC Employee Details");
        id8.setBounds(70,10,350,30);
        f.add(id8);
        ...
        aid6= new JLabel(salary);
        aid6.setBounds(250,370,300,30); 
        aid6.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid6);


        id7= new JLabel("Emp Position : ");
        id7.setBounds(50,420,200,30);
